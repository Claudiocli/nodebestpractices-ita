...
[<img src="assets/images/twitter.svg" width="16" height="16" alt="" />](https://twitter.com/nodepractices/) **Seguici su Twitter!** [**@nodepractices**](https://twitter.com/nodepractices/)

<br/>

Leggi in un'altra lingua: [![CN](./assets/flags/CN.png)**CN**](./README.chinese.md), [![FR](./assets/flags/FR.png)**FR**](./README.french.md), [![BR](./assets/flags/BR.png)**BR**](./README.brazilian-portuguese.md), [![RU](./assets/flags/RU.png)**RU**](./README.russian.md), [![PL](./assets/flags/PL.png)**PL**](./README.polish.md), [![JA](./assets/flags/JA.png)**JA**](./README.japanese.md), [![EU](./assets/flags/EU.png)**EU**](./README.basque.md) [(![ES](./assets/flags/ES.png)**ES**, ![HE](./assets/flags/HE.png)**HE**, ![KR](./assets/flags/KR.png)**KR** and ![TR](./assets/flags/TR.png)**TR** in progress! )](#translations)

<br/>

# 🎊 2024 edition is here!

- **🛰 Rimodernizzato per il 2024**: Un sacco di modifiche al testo, nuove librerie raccomandate ed alcune nuove buone prassi

- **✨ Concentrati in maniera semplice sui nuovi contenuti**: Già stato qui? Cerca i tag `#new` o `#updated` per i nuovi contenuti

- **🔖 Curioso di vedere esempi? Abbiamo un punto di partenza**: Visita [Practica.js](https://github.com/practicajs/practica), la nostra applicazione di esempio e boilerplate (beta) per vedere alcune prassi in azione

<br/><br/>

# Benvenuto! 3 Cose Che Dovresti Sapere Prima

**1. Stai leggendo dozzine dei migliori articoli su Node.js -** questa repository è una sommarizzazione e selezione dei contenuti più votati sulle buone prassi per Node.js, oltre ai contenuti scritti qui dai collaboratori

**2. È la più grande raccolta e cresce ogni settimana -** al momento sono presenti oltre 80 buone prassi, guide stilistiche e consigli architetturali. Nuove issues e pull request sono create ogni giorno per mantenere questo libro attivo aggiornato. Ci piacerebbe che contribuissi, che sia aggiustando errori nel codice, aiutare con le traduzioni o suggerendo brillanti nuove idee. Guarda le nostre [linee guida di scrittura qui](./.operations/writing-guidelines.md)

**3. Le buone prassi hanno informazioni aggiuntive -** la maggior parte dei punti include un **🔗Leggi di più**, link che approfondisce la prassi con degli esempi di codice, citazioni da blog ed altre informazioni
...
<details>
  <summary>
    <a href="#1-project-architecture-practices">1. Norme sull'Architettura del Progetto (6)</a>
  </summary>

&emsp;&emsp;[1.1 Struttura la tua soluzione con i componenti `#strategic` `#updated`](#-11-structure-your-solution-by-business-components)</br>
&emsp;&emsp;[1.2 Organizza i tuoi componenti, mantieni il livello web nei suoi confini `#strategic` `#updated`](#-12-layer-your-components-with-3-tiers-keep-the-web-layer-within-its-boundaries)</br>
&emsp;&emsp;[1.3 Ragruppa le cose di base più utili come packages e considera la pubblicazione](#-13-wrap-common-utilities-as-packages-consider-publishing)</br>
&emsp;&emsp;[1.4 Utilizza una configurazione consapevole dell'ambiente, sicura e gerarchica `#updated`](#-14-use-environment-aware-secure-and-hierarchical-config)</br>
&emsp;&emsp;[1.5 Considera tutte le conseguenze quando scegli il framework principale `#new`](#-15-consider-all-the-consequences-when-choosing-the-main-framework)</br>
&emsp;&emsp;[1.6 Usa TypeScript in maniera parsimoniosa e giudiziosa `#new`](#-16-use-typescript-sparingly-and-thoughtfully)</br>

</details>

<details>
  <summary>
    <a href="#2-error-handling-practices">2. Procedure sulla Gestione degli Errori (12)</a>
  </summary>
